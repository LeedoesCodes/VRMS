...
namespace Vehicle_Rental_Management_System
{
    public partial class Welcome : Form
    {
        ...
        public Welcome()
        {
            ...
            this.Load += (s, e) => { this.WindowState = FormWindowState.Maximized; UpdateLayout(); };
        ...
        private void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            btnProceed.Enabled = isAnimating = true;
        ...
        private void LoadControl(UserControl uc)
        {
            ...
            {
                reg.GoBackToLoginRequest += (s, e) => { showingLogin = true; LoadControl(new LoginUserControl()); };
            }
        ...
        private void FinishAnimation()
        {
            ...
            this.BackColor = panelRight.BackColor = Color.White;
            FocusContent();
            isAnimating = false;
        }
        ...
        private void UpdateFade()
        {
            ...
            int val = Math.Min(255, 30 + (int)(225 * EaseOutQuad((slideProgress - 0.1f) / 0.9f)));
            this.BackColor = panelRight.BackColor = Color.FromArgb(255, val, val, val);
        }

        private void FocusContent()
        {
            if (currentUC is LoginUserControl log) log.FocusUsername(); else currentUC?.Focus();
        }

        private void CenterUC(Control c)
        {
            if (c == null) return;
            c.Location = new Point((panelLogin.Width - c.Width) / 2, (panelLogin.Height - c.Height) / 2);
        }

        private void UpdateLayout()
        {
            panelRight.Size = panelLogin.Size = ClientSize;
            panelLeft.Size = new Size(Math.Max(400, (int)(ClientSize.Width * 0.4)), ClientSize.Height);
            CenterUC(currentUC);
        }
